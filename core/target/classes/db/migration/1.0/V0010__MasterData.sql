...
INSERT INTO List(id, modificationCounter, name, creationDate, active, orderList, id_listas) values(0,1,'Primerasss lista de tareas', CURRENT_TIMESTAMP, 1, 1, 0);
...
INSERT INTO TextItem(id, modificationCounter, creationDate, text) values (1, 1, CURRENT_TIMESTAMP, 'Primer item de la lista');
INSERT INTO TextItem(id, modificationCounter, creationDate, text) values (2, 1, CURRENT_TIMESTAMP, 'Primer item de la lista');
INSERT INTO TextItem(id, modificationCounter, creationDate, text) values (3, 1, CURRENT_TIMESTAMP, 'Primer item de la lista');

INSERT INTO FileItem(id, modificationCounter, creationDate, file) values(0, 1, CURRENT_TIMESTAMP, STRINGTOUTF8('Segundo'));
INSERT INTO FileItem(id, modificationCounter, creationDate, file) values(1, 1, CURRENT_TIMESTAMP, STRINGTOUTF8('Segundo'));
INSERT INTO FileItem(id, modificationCounter, creationDate, file) values(2, 1, CURRENT_TIMESTAMP, STRINGTOUTF8('Segundo'));
INSERT INTO FileItem(id, modificationCounter, creationDate, file) values(3, 1, CURRENT_TIMESTAMP, STRINGTOUTF8('Segundo'));

INSERT INTO Item(id, modificationCounter, creationDate, ordinal, idList, idFile, idText) values (0, 1,CURRENT_TIMESTAMP, 1, 0, 0, null);
